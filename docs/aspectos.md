...
| 2 | Organización del backend | El backend se estructura como un monolito modular, dividido internamente en módulos independientes por funcionalidad, para facilitar el mantenimiento y el trabajo paralelo del equipo. |  | [ADR 0001 - Arquitectura de monolito modular](adr/0001-usar-monolito-modular.md) |  |  | [Mantenibilidad](arc42/arc42-template-EN.md#objetivos-de-calidad) |
